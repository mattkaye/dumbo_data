...
class Dumbodata{
	...
	*/
	...
	/**
	*
	* Creates a block of copy with optional HTML tags within the copy
	* 
	* @param	$minChar	int			The minimum number of characters the copy can be. Will round to next whole word.
	* @param	$maxChar	int			The maximum number of characters the copy can be. Will round to next whole word.
	* @param	$html		boolean		If true, markup tags like <strong>,<em>,<a> will be randomly used in the copy.
	* @return	$result		string		The block of copy
	*/
	public function doText($html = false){
		$myCopy = $this->_getCopy();
		return str_replace(PHP_EOL, '<p>', $myCopy);
	}
	...
	*/
	private function _getCopy(){
		...
		switch($this->myTheme){
			...
			default:
				$copy = array(
					...
					With its beautiful screen, overclocked 1.7GHz Tegra 3 CPU, storage expansion slot, and Micro-HDMI, it succeeds in offering a viable 10-inch alternative to the iPad. If price is a concern, or you simply want a smaller tablet, the $200 Nexus 7 is powerful, comfortable, and, thanks to its support for Jelly Bean, provides one of the best Android tablet experiences yet. Check out the rest of the top tablets for more options.',
					
					1 => 'Google\'s never really been all "Drop what you\'re using and switch to Chrome OS" about the whole thing, but with this machine it seems to be more up-front about positioning it as a good extra inexpensive computer that lies around the house and can be used for quickly, easily, and securely handling the Web needs of different users. 
					
					Especially those who\'ve come to rely less and less on traditional installed software.',
					
					2 => 'The Internet Explorer wait appears to be over for Microsoft loyalists. A new preview version of Internet Explorer 10 for Windows 7 will be available tomorrow, according to LiveSide, a site that follows Windows Live. 
					...
					3 => 'Nvidia\'s flagship mobile chip is a piece of complex, quad-core machinery capable of driving speedy navigation and high frame rates in games. Some games even sport Tegra 3-specific optimizations, allowing for graphical effects not seen on any other CPU. 
					
					The problem is that from a gaming apps perspective, not enough app developers have made games that really take advantage of its power, and with newer faster processors debuting every few months, Tegra 3 may have missed its opportunity to turn the Android platform into a gaming powerhouse.
					
					A version of the chip, clocked at 1.7GHz, allows the Asus Transformer Pad Infinity TF700 to display a high-resolution, 1,920x1,200 screen with little compromise to navigation performance; however, it\'s not always fast enough to prevent low frame rates in high-end games like N.O.V.A. 3.'
				);
				break;
			...
			case 'science':
				$copy = array(
					...
					Now, researchers in California may have designed a synthetic version—a flexible, electrically conductive, self-healing polymer.',
					
					1 => 'Researchers who have assembled a trove of genetic and medical data on 100,000 northern Californians unveiled their initial findings here this week at the annual meeting of the American Society of Human Genetics (ASHG). 
					...
					3 => 'The idea is to link such genetic information with clinical data from the electronic medical records of the biobank\'s volunteers. (The participants, who also answered health surveys, averaged 63 years old, and 81% were white and the rest Asian, Latino, or African American.) 
					
					For example, researchers using the Kaiser Permanente biobank have verified previously reported links between certain genetic markers, known as SNPs (single-nucleotide polymorphisms), and cholesterol measurements tied to heart disease risk. 
			...
			case 'arts':
				$copy = array(
					...
					Thirty-one percent of the 67 offered works went unsold, resulting in a success rate comparable with the 70 percent achieved the previous night at Christie\'s.',
					
					1 => 'Currently on view in the group show "Redux" at New York\'s Cristin Tierney Gallery (through Feb. 4) are two works by Joe Fig, both related to his 2009 book on interviews, Inside the Painter\'s Studio. He\'s also included in the exhibition "Small Worlds" at the Toledo Museum of Art [through Mar. 25]. 
					
					For the book, Fig spoke with dozens of painters about their practices and the quotidian life. The interviews also resulted in a series of diorama-like sculptures showing the artists at work. Here, he talks about his model of New York painter Inka Essenhigh in her studio.',
					
					2 => 'The rectangular works—the "Eclipse" series—each have a pure white front panel, their reverse sides a high-voltage, mostly hidden monochromatic hue. The rear canvas is another single, vivid color, often a primary. Three of the smaller works, all from 2010—Primary Eclipse (Blue), Primary Eclipse (Yellow) and Primary Eclipse (Red)—form a triptych, the anterior canvases angled away from the accompanying back panels in different ways to offer variously exposed expanses of color.',
					
					3 => 'Hung on its own wall upstairs, Dyad (2012), the largest work in the show, dominated the room. More than 8½ feet tall, the piece is all white, architectonic and as full of shape-shifting, spatially deceptive feints as an unfolded Japanese screen. 
					
					Throughout the day, the natural radiance from a skylight dematerialized first one plane then another into pure glow—at least temporarily.',
				);
				break;
			...
			case 'travel':
				$copy = array(
					...
					White banquettes line the wall, with natural-wood tables and Windsor chairs in the center. Served in large portions, dishes include chorizo sausage, omelets, granola, and home fries with pork green chili. Vermont maple syrup is available (on request) for pancake eaters. 
					...
					2 => 'This franchise, diner-style donut shop on North Main Street has its own proprietary donut mix and medium-roast coffee. They make filled, frosted, sprinkled, or glazed donuts, as well as pastries like bear claws, apple fritters, and cinnamon rolls. 
					
					A chalkboard menu boasts classic breakfast options alongside with creative options, such as burritos and sweet potato waffles. This small Breckenridge location caters to the Colorado crowd with its ski and snowboard wall decorations, and it\'s popularity frequently creates waits for tables. Bring cash or use the on-site ATM.',
					
					3 => 'California\'s capital isn\'t just for legislators anymore. Stately buildings, a theater scene, laid-back restaurants, tree-lined streets, define the charming city, which—best of all—has coastal style at inland prices. 
					
					You\'ll likely want a car to get around (just be sure to avoid the city\'s rush hour traffic), but buses and shuttles do run between Old Sacramento and the downtown area.',
				);
				break;
			...
			case 'politics':
				$copy = array(
					...
					As a result, we\'re all the more appreciative of the community of sources who made it possible for us to keep our readers informed, and who believe that honest cooperation with a neutral press makes campaigns stronger, rather than weaker. Named and anonymous, you know who you are and you have our thanks.',
					
					1 => 'This was the reason why Obama\'s campaign developed a plan early, one that it stuck to, to define Romney early and disqualify him. They feared that he would be able to reposition himself in the general in a way that would be effective. 
					
					But Romney had a fear, which we\'ve written about on this page repeatedly, of being called a "flip-flopper," a label that he\'d encountered at other points in his career but avoided until it was no longer tenable, when the 47 percent video emerged.',
					...
					A Republican poll taken by Susquehanna Polling and Research showed Pennsylvania Senate candidate Tom Smith leading Democratic Sen. Bob Casey by 2 points a few weeks before the election; Casey won by 9 points.',
					
					3 => 'Both Steele and Purple Nation co-founder Lanny Davis agreed on a conference call with reporters that demagoguery and extreme comments on social issues has alienated voters who have said they could vote for Republican candidates on fiscal issues if it weren\'t for the party\'s hyper-focus on social conservatism.'
				);
				break;
			...
			case 'entertainment':
				$copy = array(
					...
					2 => 'Super-dedicated Twilight fans are currently camped out for tonight\'s last premiere of the super-successful saga, where stars Peter Facinelli and Jackson Rathbone showed their appreciation Sunday by making appearances for all the "Twihards" that have made the franchise a worldwide phenomenon. 
		...
		foreach($copy as $block){
			...
			$myCopy .= $block; // Build up the copy string
		}
